...
public class Hitunghari {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Aplikasi Penentu Jumlah Hari");
        frame.setContentPane(new Hitunghari().panel);
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (year.length() == 0 || month.length() == 0) {
                    resultLabel.setText("Tahun atau bulan tidak boleh kosong");
                } else {
                    int m = Integer.parseInt(month);
                    int y = Integer.parseInt(year);
                    int days = DayCounter.getDaysInMonth(y, m);
                    resultLabel.setText("Jumlah hari pada bulan " + month + " tahun " + year + " adalah " + days);
                }
            }
        });
